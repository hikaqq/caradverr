        ...
        <div className="flex items-center space-x-8">
          ...
          >
            <input
              ...
              className="pl-10 pr-4 py-2.5 text-sm rounded-full border border-gray-300 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-all duration-200 w-full"
